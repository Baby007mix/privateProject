$(document).ready(function() {
    ...
    function t() {
        u >= 768 ? $(".nav-menu").removeClass("nav-menu-open") : $(".nav-menu").css(
            "right", "-110%"), $(".nav .submenu").removeClass(".addSubMenu"), $(
            "body").css("overflow", "visible")
    }

    function i() {
        $(".nav-menu").removeClass("open-mobile-menu"), $(".overlay").removeClass(
                "overlay-open"), $("body").css("overflow", "visible"), $(
                ".wrapper-body, .nav-menu").css("max-height", "auto"), $(".wrapper-body")
    ...
    function o() {
        n(), sessionStorage.setItem("cartQuantity", S), sessionStorage.setItem(
            "cartItems", JSON.stringify(k))
    }
    ...
    function r(e, t, i, n, o, a) {
        var r, c = "";
        for (r = 1; r < 5; r++) c += '<option value="' + r + '"' + (n === r ?
            "selected" : "") + ">" + r + " product</option>";
        return '<li class="clearfix"><div class="item-content"><div class="item-image"><img src="' +
            e + '" alt="image"></div><div class="item-details"><h6>' + t +
            '</h6><div><i class="fa fa-heart"></i><span>1263</span></div></div></div><div class="item-price"><span>$ ' +
            i + '</span></div><a href="#" class="removeProduct" data-id="' + o +
    ...
    function c() {
        if ($("#cartItemsType2").length) {
            var e, t = "";
            for (e = 0; e < S; e++) t += r(k[e].image, k[e].name, k[e].price, k[e].quantity,
                k[e].id);
            "" === t && (t =
    ...
    if (d && m && (m = !1), $(".gallery-slider-three").slick({
            ...
            u >= 768 ? $(".nav-menu").addClass("nav-menu-open") : $(".nav-menu").css(
                "right", "0%"), $.fn.fullpage.setMouseWheelScrolling(!1), $("body").css(
                "overflow-y", "hidden"), e.stopPropagation()
        }), $("body .homep").on("click", function() {
            t(), $.fn.fullpage.setMouseWheelScrolling(!0)
        }), $(".nav li .has-subMenu, .navbar-wrapper li .has-subMenu").on("click",
            function() {
            ...
            var e = $(window).height();
            $(".wrapper-body, .nav-menu").css("max-height", e), $(".wrapper-body").css(
                "overflow", "hidden"), $(".nav-menu").addClass("open-mobile-menu"), $(
                ".overlay").addClass("overlay-open"), $("body").css("overflow",
                "hidden")
        ...
        }), $(".homep .servicepage .nav li a:not(.has-subMenu)").on("click",
            function() {
                i(), $.fn.fullpage.setMouseWheelScrolling(!0)
            }), $(".one-home-page").length && ($("#home-menu").fullpage({
            responsiveWidth: 1200,
            anchors: ["mainPage", "aboutPage", "servicepage", "workpage", "teampage",
                "careerpage", "blogpage", "productonepage", "contactpage"
            ],
            recordHistory: !0,
            menu: "#menu",
            touchstart: !1,
            ...
            afterLoad: function(e) {
                $(window).width() >= 992 && "servicepage" === e && ($(
                    ".service-inner.fig1").css({
                    left: "0px",
                    top: "-69px"
    ...
    n(), c(), a(), $(".addToCart, .action--buy").on("click", function(e) {
        ...
        void 0 !== i.id && void 0 !== i.name && void 0 !== i.price && void 0 !==
            i.image && s(i)
    ...
    function a() {
        h.forEach(function(e) {
            e.addEventListener("click", function(t) {
                t.preventDefault(), classie.remove(e.parentNode.querySelector(
                    ".filter__item--selected"), "filter__item--selected"), classie.add(
                    e, "filter__item--selected"), s.arrange({
                    filter: e.getAttribute("data-filter")
                }), c(), s.layout()
            })
        }), e.addEventListener("resize", t(function() {
            c(), s.layout()
        }, 50)), [].slice.call(v.querySelectorAll(".grid__item")).forEach(function(
            e) {
    ...
    function e() {
        this.el = document.querySelector(".compare-basket"), this.compareCtrl =
            this.el.querySelector(".action--compare"), this.compareWrapper = document.querySelector(
                ".compare"), this.closeCompareCtrl = this.compareWrapper.querySelector(
                ".action--close"), this.itemsAllowed = 3, this.totalItems = 0, this.items = [],
        ...
        this.closeCompareCtrl.addEventListener("click", function() {
            classie.add(e.el, "compare-basket--active"), classie.remove(o,
                "view--compare")
        })
    }
    ...
    e.prototype.add = function(e) {
        ...
        this.el.insertBefore(t, this.el.childNodes[0]), this.items.push(t), this.totalItems++,
            this.isFull() && classie.add(this.el, "compare-basket--full"), classie.add(
                this.el, "compare-basket--active")
    }, e.prototype._createItemPreview = function(e) {
        var t = this,
            i = document.createElement("div");
        i.className = "product-icon", i.setAttribute("data-idx", r.indexOf(e));
        var n = document.createElement("button");
        n.className = "action action--remove", n.innerHTML =
        ...
        for (var t = 0; t < this.totalItems; ++t) {
            ...
            n.className = "compare__effect", n.innerHTML = this.items[t].getAttribute(
                "data-info"), i.appendChild(n), this.compareWrapper.insertBefore(i,
                this.compareWrapper.childNodes[0])
        }
        setTimeout(function() {
            classie.remove(e.el, "compare-basket--active"), classie.add(o,
                "view--compare")
        }, 25)
